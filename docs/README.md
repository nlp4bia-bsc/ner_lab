...
| [RESTRUCTURE.md](dev/RESTRUCTURE.md) | The plan for `lab.core` / `lab.ner` / `lab.nel` / `lab.xlt`: layout, module mapping, contracts, tasks, extras, sequencing. Rationale for D82–D90. | Landed 2026-09-17; now the record of why. |
