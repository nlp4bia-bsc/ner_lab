...
`ner_lab.evaluation.scoring` remains this library's canonical evaluation.
...
from ner_lab.evaluation.scoring import group_by_document, normalize_spans, safe_f1
from ner_lab.evaluation.spans import SPAN_COLUMNS
